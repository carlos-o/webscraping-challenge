...
def test_export_cvs():
    data_frame = [
        {'Category': 'Music',
         'Cover': 'http://books.toscrape.com/media/cache/a2/fc/a2fc91793502f5c10b5826ad606de435.jpg',
         'Tax': '0.00', 'Title': 'Forever Rockers (The Rocker #12)', 'Availability': '1', 'Price (incl. tax)': '28.80',
         'Product Type': 'Books', 'Stock': '1', 'Price (excl. tax)': '28.80', 'UPC': 'e564c3f1a93ccf2e',
         'Price': '28.80',
         'Number of reviews': '0'},
        {'Price': '38.00', 'Price (incl. tax)': '38.00', 'Tax': '0.00', 'Title': 'Frankenstein',
         'UPC': 'a492f49a3e2b6a71',
         'Price (excl. tax)': '38.00', 'Availability': '1', 'Stock': '1', 'Category': 'Default',
         'Product Type': 'Books',
...
def test_get_book_data(data, result):
    data = scraper.get_book_data(data)
